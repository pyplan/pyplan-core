...
class Index(Axis):
    ...
    def __init__(self, name, values):
        ...
        self._vectorized_index = np.vectorize(
            self._indices.__getitem__, otypes=[np.int])
        self._vectorized_contains = np.vectorize(
            self._indices.__contains__, otypes=[np.bool])
